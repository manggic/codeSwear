...
const Product = ({ addToCart, data }) => {
  ...
  const checkAvailability = async () => {
    ...
    if (data.data.includes(parseInt(pincode))) {
      setService(true);
    } else {
      setService(false);
    }
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pincode pt-6">
                <input
                  className="py-1 px-1 text-sm mr-2 outline outline-2 outline-stone-900 rounded-sm"
                  type="number"
              ...
              <div
                className={`${
                  !service ? "text-red-700" : "text-green-500"
                } text-sm mt-3`}
              >
                {service === false
